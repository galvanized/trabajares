...
#pragma config(Motor,  port8,           mALB,          tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           mART,          tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port10,          mARB,          tmotorVex393_HBridge, openLoop)
